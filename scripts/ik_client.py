...
def request_joint_angles(ee_pos, joint_angles):
    ...
    try:
        request = rospy.ServiceProxy(server_name, ik, persistent=True)
        response = request(ee_pos, joint_angles)
...
if __name__ == "__main__":
    ee_pos = [0.4321299165321603, 0.15649043202597238, 0.9493153890114487,
    ...
    joint_angles = request_joint_angles(ee_pos, joint_angles)
    print(joint_angles)
